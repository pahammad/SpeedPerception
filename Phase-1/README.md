...
Our SpeedPerception-Phase1 benchmark contains 5 files formatted in CSV (comma separated value) format and named accordinly as csv1, csv2, csv3, csv4 and csv5. Each of them contains data either from the crowdsourcing component, or measurements obtained from WPT (WebPagetest) on the sample urls. These data sets have been curated to better serve the analysis purpose. <br>
